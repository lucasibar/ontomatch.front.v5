import { List, ListItem, ListItemAvatar, ListItemText, Avatar, Typography, Divider, Paper } from '@mui/material';
    ...
    return (
        <List sx={{ width: '100%', bgcolor: 'background.paper' }}>
            {conversations.map((conv) => (
                <div key={conv.id}>
                    <ListItem alignItems="flex-start" button onClick={() => onSelect(conv.id)}>
                        <ListItemAvatar>
